...
Every API key is tied to your workspace's credit balance. You can check your remaining balance in the response of any `/decisions` call via `credits_remaining`, or from **Dashboard → Settings → API Credits**.
